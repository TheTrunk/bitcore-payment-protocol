...
PaymentProtocol.PAYMENT_REQUEST_CONTENT_TYPE = 'application/hush-paymentrequest';
PaymentProtocol.PAYMENT_CONTENT_TYPE = 'application/hush-payment';
PaymentProtocol.PAYMENT_ACK_CONTENT_TYPE = 'application/hush-paymentack';
...
function magicHash(str) {
  var magicBytes = new Buffer('Hush Signed Message:\n');

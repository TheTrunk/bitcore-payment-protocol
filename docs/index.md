...
```
npm install bitcore-lib-hush --save
npm install bitcore-payment-protocol-hush --save
```

For client-side projects:

```
bower install bitcore-lib-hush --save
bower install bitcore-payment-protocol-hush --save
```
